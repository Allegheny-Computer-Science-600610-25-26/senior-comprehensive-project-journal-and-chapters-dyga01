...
This architecture creates attack surfaces related to tool descriptions: there is currently no mechanism to verify whether tool descriptions contain malicious instructions (tool poisoning), whether tool descriptions accurately represent what the underlying code actually does, or whether tool descriptions overlap and cause context confusion (tool shadowing).
...
### Accurently represent underlying code attack

does this attack even have a name
