...
rust layer does not consiste of much code but code is run many times and is important.Cryptographic operations summarize here

another one just so there are 2 small paragraph
