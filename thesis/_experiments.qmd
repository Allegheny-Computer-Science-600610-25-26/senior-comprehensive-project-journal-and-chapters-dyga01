...
by looking at figure 12, say what the results broadly show. 
dont get into too much detail with specific attacks.

x

```
Feature Comparison Table: pysealer vs. mcp-scan
...
| LLM03:2025 Supply Chain                       |    $\checkmark$    |    $\checkmark$    |
| LLM04:2025 Data and Model Poisoning           |    $\checkmark$    |    $-$    |
| LLM05:2025 Improper Output Handling           |    $\times$    |    $\checkmark$    |
| LLM06:2025 Excessive Agency                   |    $\times$    |    $\checkmark$     |
| LLM07:2025 System Prompt Leakage              |    $\times$    |    $\checkmark$     |
| LLM08:2025 Vector and Embedding Weaknesses    |    $\times$    |    $\checkmark$     |
