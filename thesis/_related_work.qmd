...
there have been many ai tools that work on top of llms.
but many of them lack standardization that mcp provides
as a response to many of these tools , anthropic, the popular llm company, responds with mcp

____specifically how langchain lacks mcp standardization here______

### Technical Innovation of MCP

explain how mcp is techincal innovatoin. 1. Client-Server Architecture and standarzised protocol json rpc

_______talk about decorators here___________
